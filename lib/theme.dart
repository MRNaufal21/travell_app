...
/// Modern gradient color palette for VeriFlow
class LightModeColors {
  // Primary gradient: Deep purple to blue
  ...
  // Secondary gradient: Teal to emerald
  ...
  // Surface: Clean white with subtle gray
  ...
  static const lightInversePrimary = Color(0xFFC7D2FE);
...
class DarkModeColors {
  // Primary gradient: Lighter purple/blue for dark
  ...
  // Surface: Deep dark with high contrast
