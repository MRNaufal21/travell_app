...
class _ManageBookingsScreenState extends State<ManageBookingsScreen> {
  ...
  Future<void> _updateBookingStatus(Booking booking, BookingStatus newStatus) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Status booking diubah menjadi ${_getStatusText(newStatus)}'),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${_bookings.length} total booking',
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text('Total', style: context.textStyles.bodyMedium?.semiBold),
                      Text(
